...
CREATE TABLE cliente(cod_cli INT NOT NULL, PRIMARY KEY(cod_cli),nome_cli VARCHAR(45),tel_cli VARCHAR(13));

CREATE TABLE produto(cod_prod INT NOT NULL, PRIMARY KEY(cod_prod),nome_prod VARCHAR(45),vlr_prod FLOAT ,qnt_prod INT);
SHOW TABLES;
